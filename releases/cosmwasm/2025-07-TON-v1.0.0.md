...
```bash
mkdir $ARTIFACT_PATH
wget $RELEASES_BASE_URL/releases/cosmwasm/ton-voting-verifier/1.0.0/voting_verifier.wasm --directory-prefix=$ARTIFACT_PATH
wget $RELEASES_BASE_URL/releases/cosmwasm/ton-multisig-prover/1.0.0/multisig_prover.wasm --directory-prefix=$ARTIFACT_PATH
```
...
```
7055d307103d5bcbed4c9465f40084acdb0f154a8dda0d8c0ee68f865892874a  wasm/voting_verifier.wasm
bee1192a8ae1d8928127bbb23e259cfadf817b930c5176cf83f7985240a7254a  wasm/multisig_prover.wasm
```
// TODO: change checksums
